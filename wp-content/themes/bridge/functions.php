...
if(!function_exists('qode_google_fonts_styles')) {
	...
	function qode_google_fonts_styles() {
		...
		$font_weight_str 		= '100,200,300,400,600,700,800,400italic';
...
/* Custom Stylesheet */
add_action( 'wp_enqueue_scripts', 'blush_stylesheet' );
function blush_stylesheet() {
    wp_enqueue_style( 'blush', QODE_ROOT . '/css/blush_styles.css' );
    wp_enqueue_script( 'blush_scripts', get_template_directory_uri() . '/js/blush_scripts.js', array(), '1.0.0', true );
}
